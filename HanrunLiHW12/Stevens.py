"""
    Example of using a query from Python
"""
...
def student_courses():
    ...
    sqlite_file = '/home/hli68/Programming/SSW810/HanrunLiHW12/810_startup.db'
...
def instructor():
    ...
    return render_template('instructor.html',
                           title='Stevens Repository',
                           table_title="Instructors with CWID, Name, Department, Course, and the number of students in the course",
                           instructors=data)
